...
const AdminDashboard = () => {
  ...
  const fetchBranchStats = async () => {
    console.log("🔄 Admin fetchBranchStats called");
    try {
      const response = await api.get("/admin/dashboard/branch-stats");
      console.log("✅ Admin fetchBranchStats response:", response.data);
      ...
      console.log("❌ Admin fetchBranchStats error:", err);
      console.error("Error fetching branch stats:", err);
    }
  };

  const fetchAnalyticsData = async () => {
    console.log("🔄 Admin fetchAnalyticsData called");
    try {
      setAnalyticsLoading(true);
      const response = await api.get("/admin/dashboard/analytics");
      console.log("✅ Admin fetchAnalyticsData response:", response.data);
      setAnalyticsData(response.data);
    } catch (err) {
      console.log("❌ Admin fetchAnalyticsData error:", err);
